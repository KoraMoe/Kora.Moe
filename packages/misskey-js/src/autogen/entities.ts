...
export type NotesDraftsGetResponse = operations['notes___drafts___get']['responses']['200']['content']['application/json'];
export type NotesDraftsSaveRequest = operations['notes___drafts___save']['requestBody']['content']['application/json'];
